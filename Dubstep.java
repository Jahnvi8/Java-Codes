...
//   Vasya inserts a certain number of words "WUB" before the first word of the song (the number may be zero), after the last word (the number may be zero),
    ...
    public static void main(String args[] ) throws Exception {
       ...
       try {
           ...
           for(int i=0;i<str.length();i++){
               if(i+2<str.length())
               {
                 temp1=String.valueOf(str.charAt(i));
                 temp2=String.valueOf(str.charAt(i+1));
                 temp3=String.valueOf(str.charAt(i+2));
                 
                  if(temp1.equals("W") && temp2.equals("U") && temp3.equals("B")){
