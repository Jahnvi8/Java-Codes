// in Chefland, there is a very famous street where N types of street food (numbered 1 through N) are offered. For each valid i, there are Si stores that offer 
// food of the i-th type, the price of one piece of food of this type is Vi (the same in each of these stores) and each day, Pi people come to buy it; each of 
// these people wants to buy one piece of food of the i-th type.
...
// food he'd offer will split equally among all stores that offer it, and if this is impossible, i.e. the number of these people p is not divisible by the 
//   number of these stores s, then only ⌊ps⌋ people will buy food from Chef.
	...
	public static void main (String[] args) throws java.lang.Exception
	{
		...
		while(t-->0){
		    ...
		    for(int i=0;i<n;i++){
		        ...
		        int shopShare = (int)Math.floor(a[1]/(a[0]+1));
		      
		        int amount = shopShare*a[2];
		        b[i] = amount;
		    }
		    Arrays.sort(b);
