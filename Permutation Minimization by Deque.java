...
// The first line of each test case description contains an integer n (1≤n≤2⋅105) — permutation size. The second line of the description contains n space-separated 
// integers pi (1≤pi≤n; all pi are all unique) — elements of the permutation.

// It is guaranteed that the sum of n over all test cases does not exceed 2⋅105.

// Output
// Print t lines, each line containing the answer to the corresponding test case. The answer to a test case should contain n space-separated 
// integer numbers — the elements of the lexicographically smallest permutation that is possible to find in the deque after executing the described algorithm.
	    ...
	    try {
	           ...
	           Scanner sc=new Scanner(System.in);
	            ...
	            while(t-->0){
	              ...
	              for(int i=1;i<n;i++){
	                  int x=sc.nextInt();
	                  if(x<dq.getFirst()) dq.addFirst(x);
	                  else dq.addLast(x);
